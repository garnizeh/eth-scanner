...
- [ ] Unit tests for `LeaseJob` (available, expired, prefix affinity).
- [ ] Unit tests for `UpdateCheckpoint` (nonce validation).
- [ ] Unit tests for `CompleteJob`.
- [ ] Mock database interactions for efficiency.
