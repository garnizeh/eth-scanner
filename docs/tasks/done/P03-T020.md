...
- [x] File `go/internal/api/server.go` exists
...
Implemented `go/internal/api/server.go` with the following features:
...
- `go/internal/api/server.go` — main server implementation
