...
- [x] File `go/internal/api/middleware.go` exists
...
See `go/internal/api/middleware.go` for implementation. Generated 16-byte hex request IDs, UTC timestamps for logs, and a ResponseWriter wrapper to capture status codes. Added unit tests in `go/internal/api`:
...
- `go/internal/api/middleware.go` (new)
- `go/internal/api/middleware_test.go` (new)
- `go/internal/api/server_test.go` (new)
- `go/internal/api/server_start_test.go` (new)
